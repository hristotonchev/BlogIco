 ...
 */
    public function list_action()
    {
        ...
        $this->renderTemplate('templates/index.tpl.html', [
        'pageTitle' => 'Home',
        'currentPage' => 'home',
        'posts' => $posts,
        ]);
 ...
 */
    public function list_single_blog($id)
    {
        if (!empty($id) && $id != null) {
            ...
            $this->renderTemplate('templates/blogs.tpl.html', [
 ...
 */
    ...
    {
        $this->renderTemplate('templates/about.tpl.html', [
        'pageTitle' => 'About',
        'currentPage' => 'about',
        ]);
    }
 ...
 */
    ...
    {
        $this->renderTemplate('templates/contact.tpl.html', [
        'pageTitle' => 'Contact',
        'currentPage' => 'contact',
        ]);
    }
 ...
 */
    ...
    {
        $this->renderTemplate(
            'templates/pagenotfound.tpl.html',
            [
